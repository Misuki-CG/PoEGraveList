...
namespace PoEGraveList.ViewModels
{
    class MainWindowViewModel : ViewModelBase
    {
        ...
        {
            this._historyViewModel = new HistoryViewModel();
        ...
        private void loadQuery()
        {
            ...
            this._historyViewModel.AddHistory(shopItems);
            this._historyViewModel.SelectedHistory = this._historyViewModel.History.First();
        }
